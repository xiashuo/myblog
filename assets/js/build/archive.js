$(document).ready(function () {
    ...
    $.getJSON("blog_data.json", function (data, textStatus, jqXHR) {
        // console.log(xiashuobad.formatData(data));
        xiashuobad.formatjson = xiashuobad.formatData(data); //格式化数据
        var $cl = $('.car-list');

        for (let index = 0; index < xiashuobad.formatjson.length; index++) {
            const element = xiashuobad.formatjson[index];
