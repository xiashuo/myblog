...
var mynewTabDirPath = "extensions\\myNewTab@developer.com\\chrome\\content\\myNewTabForeign";
// 图片存储的文件夹名字，相对于上面的路径
...
var NewTab = {
	...
	buildTr: function (type, sites) {
		...
		for (var i = 0, l = sites.length; i < l; i++) {
			...
			//img.setAttribute("onerror","javascript:this.src='img/commen.png'")
			a.appendChild(img);
	...
	localImage: function (m) {
		...
		file.appendRelativePath(mynewTabDirPath);
...
function openDir() {
	...
	dsFile.appendRelativePath(mynewTabDirPath);
	dsFile.reveal();
}
